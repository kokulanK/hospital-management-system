...
export default function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/dashboard/admin/pending-approvals" element={<PrivateRoute allowedRoles={["admin"]}><AdminLayout activePage="pending"><PendingApprovals /></AdminLayout></PrivateRoute>} /> {/* ✅ Added */}
