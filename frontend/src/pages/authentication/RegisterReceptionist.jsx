...
import { FaUserMd, FaEnvelope, FaLock, FaConciergeBell } from "react-icons/fa";
...
const RegisterReceptionist = () => {
  ...
  const styles = {
    ...
    message: { color: "#2ecc71", marginBottom: "10px", fontWeight: "500" }, // ✅ NEW
  ...
  return (
    <div style={styles.wrapper}>
      <div style={styles.card}>
        ...
        <h2 style={styles.headerText}>Register as Receptionist</h2>

        {error && <p style={styles.error}>{error}</p>}
        {message && <p style={styles.message}>{message}</p>} {/* ✅ NEW */}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.inputGroup}><FaLock /><input style={styles.input} type="password" value={password} placeholder="Password" onChange={handlePasswordChange} required /></div>
