...
import { FaUserMd, FaEnvelope, FaLock, FaBroom } from "react-icons/fa";

const RegisterCleaningStaff = () => {
  ...
  return (
    <div style={styles.wrapper}>
      <div style={styles.card}>
        <FaBroom style={styles.icon} />
        <h2 style={styles.headerText}>Register as Cleaning Staff</h2>
...
export default RegisterCleaningStaff;