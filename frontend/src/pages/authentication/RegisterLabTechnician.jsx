...
import { FaUserMd, FaEnvelope, FaLock, FaTools } from "react-icons/fa";

const RegisterLabTechnician = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      navigate("/dashboard/labtechnician");
    } else {
  ...
  return (
    <div style={styles.wrapper}>
      <div style={styles.card}>
        ...
        <h2 style={styles.headerText}>Register as Lab Technician</h2>
...
export default RegisterLabTechnician;