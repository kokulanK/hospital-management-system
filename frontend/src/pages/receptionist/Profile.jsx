...
export default function ReceptionistProfile() {
  ...
  const roleDisplay = user?.role ? user.role.charAt(0).toUpperCase() + user.role.slice(1) : 'Receptionist';
      ...
      <div className="hero-profile rounded-2xl p-7 md:p-9 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-5">
          ...
          <div>
            ...
            <h1 className="display-font text-2xl md:text-3xl font-semibold">{user?.name || 'Receptionist'}</h1>
