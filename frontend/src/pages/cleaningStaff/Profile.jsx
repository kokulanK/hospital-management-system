      ...
      <div className="profile-root max-w-3xl mx-auto space-y-6 pb-10">
        ...
        <div className="hero-profile rounded-2xl p-7 md:p-9 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center gap-5">
            ...
            <div>
              <p className="text-blue-200 text-xs font-medium tracking-widest uppercase mb-1">Cleaning Staff Account</p>
              <h1 className="display-font text-2xl md:text-3xl font-semibold">{user?.name || 'Staff'}</h1>
