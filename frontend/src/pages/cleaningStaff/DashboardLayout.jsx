...
export default function DashboardLayout({ children, activePage }) {
  ...
  const links = [
    ...
    { to: '/dashboard/cleaning/supplies', icon: FaBox, label: 'Supply Requests', key: 'supplies' }, // ✅ Added
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      <aside className="clean-sidebar fixed top-0 left-0 h-screen w-20 bg-white flex flex-col items-center justify-between py-5"
